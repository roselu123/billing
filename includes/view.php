...
if (isset($_GET['user_id'])) {
    ...
    while ($row = mysqli_fetch_assoc($view_billing)) {
       ...
       // Displaying multiple collateral images as links to the uploaded pictures
	   echo "<td>";
if (!empty($c_images)) {
    foreach ($c_images as $c_image) {
        ...
        echo "<a href='{$imagePath}' target='_blank'>View Image</a><br>"; // Creating a link to view the image   
    }
} else {
...
// Displaying the promissory note image
echo "<td>";
if (!empty($p_note)) {
